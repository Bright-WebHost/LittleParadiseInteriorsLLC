				...
				<footer className="ltn__footer-area"  >
				  <div className="footer-top-area  section-bg-2 plr--5" style={{backgroundColor:"#CB4D29"}}>
				    <div className="container-fluid">
				      <div className="row">
				        <div className="col-xl-4 col-md-6 col-sm-6 col-12 mt-1">
						  ...
						  <div className="footer-logo" id='responsive-text-project-heading' >
				              <div className="site-logo">
				                <a href='/' target='_blank'><img src={publicUrl+"assets/img/Allimgs/colored-logo.png"} alt="Logo" style={{height:'120px',width:'auto' ,marginTop:'40px'}}  id="footeimg" /></a>
				              </div>
				        ...
				        <div className="col-xl-4 col-md-6 col-sm-12 col-10 mt-100">
						...
						<div className="col-xl-4 col-md-6 col-sm-12 col-10 mt-90">
				          <div className="footer-widget footer-newsletter-widget">
							<div className="footer-address-info">
							<div className="footer-address-info" >
									<style>{`
					  ...
					  `}</style>	
				                    <p id="footerstyle" className='contactlinefooter ml-30 '><a href="tel:+971525238899"> +971525238899</a></p>
